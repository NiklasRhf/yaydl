...
pub struct Texts {
    ...
    pub release_notes_help: &'static str,
...
pub const EN: Texts = Texts {
    ...
    section_about: "About yaydl",
    app_version: "Version",
    check_for_updates: "Check for updates",
    checking_for_updates: "Checking\u{2026}",
    up_to_date: "yaydl is up to date.",
    release_notes: "Release notes",
    release_notes_help: "What changed in this version, opens in your browser.",
...
pub const DE: Texts = Texts {
    ...
    section_about: "Über yaydl",
    app_version: "Version",
    check_for_updates: "Nach Updates suchen",
    checking_for_updates: "Suche\u{2026}",
    up_to_date: "yaydl ist auf dem neuesten Stand.",
    release_notes: "Versionshinweise",
    release_notes_help: "Was sich in dieser Version geändert hat, öffnet sich im Browser.",
